...
public class MainGameActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sb = Typeface.createFromAsset(getAssets(), "fonts/PlayfairDisplay-Regular.ttf");
    ...
    public void buttonA(View view) {
        ...
        if (currentQuestion.getOptA().equals(currentQuestion.getAnswer())) {
            buttonA.setButtonColor(ContextCompat.getColor(getApplicationContext(),R.color.green_600));
    ...
    public void buttonB(View view) {
        if (currentQuestion.getOptB().equals(currentQuestion.getAnswer())) {
            buttonB.setButtonColor(ContextCompat.getColor(getApplicationContext(),R.color.green_600));
            if (qid < list.size() - 1) {
                disableButton();
                correctDialog();
            } else {
    ...
    public void buttonC(View view) {
        if (currentQuestion.getOptC().equals(currentQuestion.getAnswer())) {
            buttonC.setButtonColor(ContextCompat.getColor(getApplicationContext(),R.color.green_600));
            if (qid < list.size() - 1) {
                disableButton();
                correctDialog();
            } else {
    ...
    public void buttonD(View view) {
        if (currentQuestion.getOptD().equals(currentQuestion.getAnswer())) {
            buttonD.setButtonColor(ContextCompat.getColor(getApplicationContext(),R.color.green_600));
            if (qid < list.size() - 1) {
                disableButton();
                correctDialog();
            } else {
